...
public class Tester {
    public static void main (String[]args) {
        ...
        HotelResource.bookARoom("asd@asd.com", HotelResource.getRoom("2"), new Date(2010/05/05), new Date(2010/06/06));
        HotelResource.getCustomersReservations("asd@asd.com");
        HotelResource.findARoom(new Date(2010/05/05), new Date(2010/06/06));
